...
namespace WoldCup
{
    ...
    public enum Time { [JsonProperty("full-time")] FullTime };
    ...
    {
        public static string ToJson(this Match[] self) => JsonConvert.SerializeObject(self, WoldCup.Converter.Settings);
    }
